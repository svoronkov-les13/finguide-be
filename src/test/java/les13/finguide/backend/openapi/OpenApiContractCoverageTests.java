...
class OpenApiContractCoverageTests {
    ...
    private static final Set<String> KNOWN_CONTRACT_OPERATIONS_NOT_IN_SPRINGDOC = Set.of(
            ...
            "GET /api/v1/plans/{planId}/analytics/assumptions",
            "GET /api/v1/plans/{planId}/analytics/balance/current",
            "GET /api/v1/plans/{planId}/analytics/projection",
            ...
            "GET /api/v1/plans/{planId}/pension/projection",
            "GET /api/v1/scenarios/{scenarioId}",
            "PATCH /api/v1/me",
            "PATCH /api/v1/plans/{planId}/analytics/assumptions",
